...
<!-- ===Navbar start=== -->
<nav class="container-fluid bg-c1-1" style="height:auto; padding-bottom: 20px;">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <!-- Content -->
                    <a class="navbar-brand" href="admin/index.php"> <img src="img/mainlogo.png" style="width:170px;"
                            alt="Logo"> </a>
