    ...
    if ($numexist > 0) {
        ...
        if (mysqli_num_rows(mysqli_query($conn, $emailSql)) > 0) {
            ...
            if ($password == $cpassword) {
                ...
                // insert into LOGIN TABLE incl Token
                $sql = "INSERT INTO `login` (`login_id` , `role_id`, `username`,`password`, `is_verified`, `verification_code`) VALUES ('', '2', '$username', '$hash', '0', '$token')";
                ...
                if ($result) {
                    ...
                    if ($result2) {
                        ...
                        if (sendVerificationEmail($email, $token)) {
                            echo "<script>
                             alert('SP Account Created! Please check your email ($email) to verify your account.');
